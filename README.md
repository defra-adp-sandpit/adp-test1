...
| APPINSIGHTS_CLOUDROLE        | Role used for filtering metrics | no       |         |       | Set to `adp-test1-local` in docker compose files                                                                |
...
`docker-compose -p adp-test1-test -f docker-compose.yaml -f docker-compose.test.yaml up`
...
`docker-compose -p adp-test1-test -f docker-compose.yaml -f docker-compose.test.watch.yaml up`
